...
class Validator():
    ...
    def check_role(self, user_id,role):
        ...
        self.cursor.execute("select supervisor_pid from personnel where pid=:user_id",{"user_id":user_id})
        result = self.cursor.fetchall()
    ...
    def check_password(self, username, password):
        ...
        self.cursor.execute("select password from users where login=:username",{"username":username})
    ...
    def register(self, userId, role, login, password):
        ...
        self.cursor.execute(insert_user,{"user_id":userId,"role":role.lower(),"login":login.lower(),"password":hash_pwd})
        self.connection.commit()
        return True